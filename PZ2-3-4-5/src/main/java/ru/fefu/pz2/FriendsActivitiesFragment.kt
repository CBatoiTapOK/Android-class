...
import ru.fefu.pz2.databinding.FragmentFriendsActivitiesBinding

class FriendsActivitiesFragment : Fragment() {
    ...
    private var _binding: FragmentFriendsActivitiesBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFriendsActivitiesBinding.inflate(inflater, container, false)
    ...
    companion object {
        fun newInstance(loggedInUsername: String): FriendsActivitiesFragment {
            val fragment = FriendsActivitiesFragment()
            val args = Bundle()
